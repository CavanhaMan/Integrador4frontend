...
public class EdIgrejaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ed_igreja);
    ...
    public void editarIgreja(View view) {
        ...
        Call call = retrofitService.getServico().editarIgreja(tid,igreja);
        call.enqueue(new Callback<Igreja>() {
            @Override
            public void onResponse(Call<Igreja> call, Response<Igreja> response) {
                Log.i("teste","Entrou Post!");
                Intent i = new Intent(EdIgrejaActivity.this, MainActivity.class);
                startActivity(i);
            }

            @Override
            public void onFailure(Call<Igreja> call, Throwable t) {
                Toast.makeText(EdIgrejaActivity.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
